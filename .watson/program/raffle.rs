...
declare_id!("Raff1eFXd6RxKHKvXNbS8JkPLh3WYw8HXfwGcyuLvjCQ");
...
pub mod raffle {
    ...
    pub fn initialize(ctx: Context<Initialize>) -> Result<()> {
        ...
        raffle_state.admin_auth_1 = Pubkey::from_str("CFn1rRSsEErL6odfyvdqpAMuJr5d2Bwk4whiAsMukJjK").unwrap();
        raffle_state.admin_auth_2 = Pubkey::from_str("8rEGjzfq9u7FG3stzv4KjcNb2Vnvu8TeRJnYM7SAadYf").unwrap();
        raffle_state.admin_auth_3 = Pubkey::from_str("BKLfwUHia9MwnDhnJUj6bMyguVxcn96SNGsEgUVRhjdx").unwrap();
        raffle_state.payout_wallet = Pubkey::from_str("7wqYGrDJmYPdqeoqsM2bdNGb6yhoZSQzZiwyEEJBCgq6").unwrap();
    ...
    pub fn select_winner(ctx: Context<SelectWinner>) -> Result<()> {
        ...
        let recent_blockhash = ctx.accounts.recent_slot_hash.to_account_info().data.borrow();
